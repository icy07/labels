    ...
    (() => {
        ...
        let formValidate = {
            ...
            validateInput(formRequiredItem) {
                let error = 0;
                let exp = /\+7\s\(\d\d\d\)\s\d\d\d-\d\d-\d\d/;
        ...
        function initSliders() {
            ...
            if (document.querySelector(".swiper")) {
                ...
                if (infoSlider) {
                    const titles = infoSlider.querySelectorAll(".info__block-title");
                    const titlesArray = [];
                    titles.forEach((title => {
                        titlesArray.push(title.innerText);
                    }));
                    new core(".info__slider", {
                        ...
                        simulateTouch: false,
                        pagination: {
                            el: ".info__pagination-sqares, .info__pagination-btns",
                            clickable: true,
                            renderBullet: function(index, className) {
                                return '<span class="' + className + '">' + titlesArray[index] + "</span>";
                            }
                        },
                        navigation: {
                            prevEl: ".info__prev",
                ...
                if (window.innerWidth < 560) enableGridSwiper(); else disableGridSwiper();
                ...
                let worksBlock = document.querySelectorAll(".works__block");
                if (worksBlock) worksBlock.forEach((function(container) {
                    let prevButton = container.querySelector(".works__prev");
                    let nextButton = container.querySelector(".works__next");
                    new core(container.querySelector(".works__slider"), {
                        modules: [ Navigation ],
                        observer: true,
                        observeParents: true,
                        slidesPerView: 1,
        ...
        function pageNavigation() {
            ...
            function pageNavigationAction(e) {
                if (e.type === "click") {
                    ...
                    if (targetElement.closest("[data-goto]")) {
                        ...
                        if (!targetElement.closest("[data-goto-thanks]")) e.preventDefault();
                    }
            ...
            if (getHash()) {
                ...
                goToHash ? gotoBlock(goToHash, false, 500, 40) : null;
            }
        }
        setTimeout((() => {
